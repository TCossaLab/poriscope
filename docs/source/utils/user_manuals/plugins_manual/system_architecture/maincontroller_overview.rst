...
Beyond coordination, the MainController also triggers plugin discovery and handles instantiation and communication. Think of it as the “brain” of Poriscope — ensuring smooth interaction between user-facing components and backend logic.
