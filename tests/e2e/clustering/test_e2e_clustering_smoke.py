...
# NOTE: this file lives at tests/e2e/clustering/, same depth as
# tests/e2e/event_analysis/ and tests/e2e/metadata/, so parents[3] reaches
# the repo root from here.
...
def test_open_clustering_tab_via_clicks(qtbot, tmp_path):
    """
    E2E/UX smoke test: start the MVC shell and open the Clustering tab via the menu.
    ...
    # 2) Open Clustering tab via menu using the hybrid helper:
