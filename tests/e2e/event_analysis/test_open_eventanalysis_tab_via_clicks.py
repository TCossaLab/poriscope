# Run with: pytest tests/e2e/event_analysis/test_open_eventanalysis_tab_via_clicks.py -v
"""
Smoke test for opening the Event Analysis tab.
...
def test_open_event_analysis_tab_via_clicks(qtbot, tmp_path):
    """
    Launching the app and choosing the menu entry creates a working Event
    Analysis tab.
